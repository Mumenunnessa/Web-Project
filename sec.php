...
<div class="comtainer-fluid sub_section pt-5 pb-5" id="Preventionid">  <!--padding top, padding bottom-->
  <div class="section_header text-center mb-5 mt-5"> <!--margine bottom, top -->
...
<div class="comtainer-fluid pt-5 pb-5" id="Contactid">  <!--padding top, padding bottom-->
  <div class="section_header text-center mb-5 mt-5"> <!--margine bottom, top -->
...
<div class="container">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" name="Mobile No." placeholder="Mobile No." autocomplete="off" required>  <!--/*required is basic validation*/-->
